...
pub fn deep_q_test(num_tests:i32){
    ...
    let mut player1 = Player2Deep::new(NeuralNetwork::from_layers(load_layers("saved_weights1_1.bin").unwrap()),Tile::Blue);
